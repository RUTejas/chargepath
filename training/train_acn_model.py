...
CONFIG = {
    ...
    "n_heads":        4,
    "dropout":        0.15,
    "batch_size":     128,     # INCREASED for faster batches
    "lr":             1e-3,
    "weight_decay":   1e-4,
    "epochs":         2,       # EXTREME REDUCTION: just 2 epochs
    "patience":       1,       # EXTREME REDUCTION
    "grad_clip":      1.0,
    "train_ratio":    0.05,    # EXTREME REDUCTION: Train on only 5% of data
    "val_ratio":      0.05,    # EXTREME REDUCTION: Validate on only 5% of data
    "device":         "cuda" if torch.cuda.is_available() else "cpu",
    "ckpt_dir":       "checkpoints",
    "results_dir":    "results",
    "use_weather":    True,
    "lambda_pinball": 0.30,    # weight of quantile loss
    "hg_sample_size": 100,     # EXTREME REDUCTION: Graph built on tiny sample
}
